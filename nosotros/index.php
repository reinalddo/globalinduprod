    ...
    <section class="main-content">
      ...
      <div class="clients-intro" style="margin:36px 0;">
        <div class="clients-card">
          <h3>Misión</h3>
          <p>Ofrecer suministros, servicios de montaje, fabricación y mantenimiento industrial, servicios múltiples y de apoyo en logísticas industriales, seguridad industrial y otros que nos permitan ser un outsourcing oportuno, técnico, eficiente y de calidad.</p>
        </div>
        <div class="clients-card">
      ...
      <ul class="feature-list" style="margin-top:16px;">
        <li>Estandarización: si no hay estándar, no hay mejora.</li>
        <li>Tecnología: soluciones soportadas en herramientas y procesos de vanguardia.</li>
        <li>Calidad: cumplimiento de normas y auditorías técnicas en cada entrega.</li>
        <li>Oportunidad: respuesta ágil y confiable según los acuerdos con cada cliente.</li>
      </ul>
